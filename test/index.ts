...
signatureTest({
  ...
  signature:
    '0x16f85b247cedca22c62bc3a180b394e018c274ab1cc946f7ba3fa815ecc83f946e3d8ba19c9780fa836ea250f5990268e9406538156750d8665902d89851dc261c',
...
signatureTest({
  ...
  signature:
    '0xb311554510121f4ea6adab62154eb3c0ac2ab1fe03a4ef842e7b05016b60908c4972c22f95a2bb0596d657976d027e69c9c92f3c9674f8c32536a3691fcf3c251c',
  addressHex: '0x1e93f9bacbcffc8ee6663f2647917ed7a20a57bb',
  privateKey: Buffer.from(
    '6969696969696969696969696969696969696969696969696969696969696969',
    'hex'
...
signatureTest({
  ...
  message: '0x0cc175b9c0f1b6a831c399e26977266192eb5ffee6ae2fec3ad71c777531578f',
  signature:
    '0x3bb6c10d5b43dda237790e3244acd2016d5b2dcd21d496893beb090d0d5f8da04d2af86ea34195ad2cd246fd0eea3eb1c8cc1720f6f900d26909761ec0dd01701b',
...
test('signedTypeData', (t) => {
  ...
  t.equal(
    cfxUtil.bufferToHex(utils.hashType('Mail', typedData.types)),
  ...
  t.equal(
    cfxUtil.bufferToHex(utils.sign(typedData)),
    '0xbe609aee343fb3c4b28e1df9e632fca64fcfaede20f02e86244efddf30957bd2'
  );
  t.equal(
    cfxUtil.bufferToHex(address),
    '0x1d2a3d9f938e13cd947ec05abc7fe734df8dd826'
  );
  t.equal(
    sig,
...
test('signedTypeData_v4', (t) => {
  ...
  t.equal(
    cfxUtil.bufferToHex(utils.hashType('Person', typedData.types)),
...
test('signedTypeData_v4 with recursive types', (t) => {
  ...
  t.equal(
    cfxUtil.bufferToHex(address),
    '0x165a687103c9f6467380bee800ecd70b17f6b72f'
  );
